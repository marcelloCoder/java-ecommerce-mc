...
public class Utils {
    ...
    public static List<Product> replace(List<ProductProjection> ordered, List<Product> unordered) {
        ...
        Map<Long, Product> productMap = new HashMap<>(); // preencher esse map com uma lista desordenada
        ...
        for(ProductProjection obj : ordered){ // para cada projection, adicionar o produto correspondente a projection
